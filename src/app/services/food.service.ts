...
export class FoodService {
  ...
  updateMenuItem(restaurantId: string, menuItemId: string, updates: any): Observable<ApiResponse<MenuItem>> {
    ...
    return this.http.put<ApiResponse<MenuItem>>(
      `${this.apiUrl}/${restaurantId}/menus/${menuItemId}`,
      updates,
      { headers }
    ).pipe(
      catchError((error) => {
  ...
  // PUT update order
  updateOrder(restaurantId: string, orderId: string, orderData: any): Observable<ApiResponse<any>> {
    return this.http.put<ApiResponse<any>>(`${this.apiUrl}/${restaurantId}/orders/${orderId}`, orderData).pipe(
      catchError((error) => {
