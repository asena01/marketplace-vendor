...
interface MenuItem {
  ...
  discountPrice?: number; // Display as original/marked price
                    ...
                    <td class="px-6 py-4 font-medium text-slate-900">
                      <div class="flex flex-col">
                        ...
                        @if (item.discountPrice && item.discountPrice > item.price) {
                          <span class="text-gray-400 line-through text-sm">₦{{ item.discountPrice.toFixed(2) }}</span>
                        }
                      </div>
                    </td>
          ...
          <div class="bg-white rounded-lg p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <form (ngSubmit)="saveMenuItem()" class="space-y-6">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- Price -->
                <div>
                  <label class="block text-sm font-medium text-slate-700 mb-2">Actual Price (Sale Price) *</label>
                  <input
                    type="number"
                ...
                <!-- Discount Price -->
                <div>
                  <label class="block text-sm font-medium text-slate-700 mb-2">Display Price (Original/Marked)</label>
                  <input
                    type="number"
                    [(ngModel)]="newMenuItem.discountPrice"
                    name="discountPrice"
...
export class RestaurantMenuComponent implements OnInit {
  ...
  saveMenuItem() {
    ...
    console.log('📤 Sending menu item payload:', {
      ...
      discountPrice: this.newMenuItem.discountPrice,
