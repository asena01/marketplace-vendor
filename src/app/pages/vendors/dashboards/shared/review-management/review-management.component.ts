  ...
  reviews = signal<Review[]>([
    {
      ...
      comment: 'Outstanding experience! The staff was friendly, the rooms were clean, and the amenities were top-notch. Will definitely come back.',
      date: '2024-03-02',
      status: 'approved',
    ...
    },
    {
      ...
      rating: 4,
      title: 'Great Stay',
      comment: 'Very good overall. Room was comfortable and the location is convenient. Only minor issue with breakfast timing.',
      date: '2024-03-01',
      status: 'approved',
    ...
    },
    {
      ...
      comment: 'It was okay. Nothing special but nothing terrible either. Room was a bit small but the price was fair.',
      date: '2024-02-28',
      status: 'pending',
      category: 'Overall Experience',
      verified: true
    },
    {
      ...
      comment: 'The team went above and beyond to make my stay comfortable. Every request was handled promptly.',
      date: '2024-02-27',
      status: 'approved',
    ...
    },
    {
      ...
      rating: 2,
      title: 'Disappointing',
      comment: 'Had high expectations but the room was not as clean as expected. WiFi was slow.',
      date: '2024-02-26',
      status: 'pending',
    ...
    },
    {
      ...
      comment: 'Everything was perfect for my business trip. Good bed, fast internet, friendly staff.',
      date: '2024-02-25',
      status: 'approved',
    ...
    },
    {
      ...
      rating: 4,
      title: 'Good Value',
      comment: 'Good value for money. Clean rooms, helpful staff. Would have appreciated more variety in breakfast.',
      date: '2024-02-24',
      status: 'approved',
    ...
    },
    {
      ...
      comment: 'Very disappointed. Cold room, noisy neighbors, unhelpful staff. Would not stay again.',
      date: '2024-02-23',
      status: 'pending',
      category: 'Overall Experience',
      verified: false
