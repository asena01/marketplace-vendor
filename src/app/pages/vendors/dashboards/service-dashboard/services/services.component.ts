...
export class ServiceServicesComponent implements OnInit {
  ...
  saveService(): void {
    ...
    const data = { ...this.currentForm, serviceProvider: this.providerId };
  ...
  private validateForm(): boolean {
    if (!this.currentForm.name || !this.currentForm.description || !this.currentForm.basePrice || !this.currentForm.duration || !this.currentForm.serviceArea) {
