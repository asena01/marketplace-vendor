...
export class FoodComponent implements OnInit {
  ...
  startOrderTracking(): void {
    ...
    const statuses: Array<'confirmed' | 'preparing' | 'ready' | 'on_the_way' | 'delivered'> = [
      'confirmed',
      'preparing',
      'ready',
      'on_the_way',
    ...
    const interval = setInterval(() => {
      if (statusIndex < statuses.length) {
        ...
        if (order) {
          ...
          if (statusIndex === 3) {
            updatedOrder.driverName = 'John Smith';
            updatedOrder.driverPhone = '+1-555-9999';
            updatedOrder.driverRating = 4.9;
            updatedOrder.currentLocation = 'On the way to your address';
          }
  ...
  updateOrderStatus(): void {
    // Auto-update status for demo purposes
  }
