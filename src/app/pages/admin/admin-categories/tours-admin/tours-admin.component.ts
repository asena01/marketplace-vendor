  ...
  template: `
    <div class="space-y-4">
      ...
      <div class="flex items-center gap-3 mb-4">
        <span class="material-icons text-3xl text-teal-600">flight_takeoff</span>
        <div>
          <h2 class="text-2xl font-bold text-gray-800">Tours & Travel Management</h2>
          <p class="text-xs text-gray-600">Manage tour operators, guides, bookings, and payments</p>
        </div>
      </div>
