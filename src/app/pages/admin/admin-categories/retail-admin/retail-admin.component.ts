  ...
  template: `
    <div class="space-y-4">
      ...
      <div class="flex items-center gap-3 mb-4">
        <span class="material-icons text-3xl text-red-600">storefront</span>
        <div>
          <h2 class="text-2xl font-bold text-gray-800">Retail Stores Management</h2>
          <p class="text-xs text-gray-600">Manage retail vendors, staff, inventory, and payments</p>
        </div>
      </div>
